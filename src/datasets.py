...
from src.transforms import ToKSpace, CutFrames
...
class PairedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Resize + CenterCrop in image domain (real channels for torchvision)
        ...
        # Resize + CenterCrop mask (nearest-neighbor to keep binary)
